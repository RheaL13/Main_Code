...
class MainWindow:
    ...
    def __init__(self, master):
        ...
        self.master.geometry(
            f"{MAIN_WINDOW_WIDTH}x{MAIN_WINDOW_HEIGHT}+{x_place}+{y_place}")
    ...
    def open_dashboard(self):
        ...
        self.dashboard_window = DashboardWindow(
            self.master, self.pending_user_info)
...
class LoginWindow:
    ...
    def __init__(self, parent):
        ...
        self.login_window.geometry(
            f"{window_width}x{window_height}+{x_place}+{y_place}")
    ...
    def validate_login(self, username, password):
        ...
        try:
            ...
            mb.showwarning("Error", f"No account found for username '{username}'. Please sign up first.",
...
class SignUpWindow:
    ...
    def signup(self):
        ...
        self.question_window = QuestionWindow(self.parent, word_list,
                                              self.signup_window,
...
class QuestionWindow:
    ...
    def __init__(self, parent, word_list, signup_window, user_info):
        ...
        title1 = tk.Label(self.window, text="\nThere will be a short quiz that" +
                          ...
                          "next. Try your best :)", bg=BG_COLOUR,
                          font=("Helvetica", 12, "bold"), fg="black")
        title1.pack(pady=1)

    def disable_close(self):
        """Shows a warning if they try to close."""
        mb.showwarning("Warning", "You must answer the questions.", parent=self.window)
    ...
    def open_level_quiz(self):
        ...
        # Set window geometry
        self.levelquizwindow.geometry(
            f"{window_w}x{window_h}+{x_position}+{y_position}")
    ...
    def finish(self):
        ...
        checked_words = [word for word,
                         var in self.word_vars.items() if var.get()]
...
class LevelQuiz:
    ...
    def buttons(self):
        ...
        next_button = tk.Button(self.root, text="NEXT", bg="white", fg="black",
                                width=7, font=("Helvetica", 16, "bold"),
                                height=1, command=self.next_btn)
    ...
    def display_question(self):
        ...
        self.q_label = tk.Label(self.root, anchor='w', wraplength=900,
                                text=self.data['question'][self.q_no],
                                width=100, font=('Helvetica', 20, 'bold'),
                                justify='left', bg=BG_COLOUR, fg="black")
...
class MainQuiz:
    ...
    def __init__(self, root, quiz_data, user_info, quiz_topic, quiz_level):
        ...
        style.configure("green.Horizontal.TProgressbar",
                        ...
                        background=FG_COLOUR)
        self.progress_var = tk.DoubleVar()
        self.progress = ttk.Progressbar(self.root, maximum=100, length=300,
                                        variable=self.progress_var,
                                        style="green.Horizontal.TProgressbar")
        self.progress.place(x=50, y=95)
        self.update_progress_bar()
    ...
    def display_question(self):
        ...
        if hasattr(self, 'q_label'):
            self.q_label.destroy()  # Destroy previous question label
        self.q_label = tk.Label(self.root, anchor='w', wraplength=900,
                                text=self.quiz_data['question'][self.q_no],
                                width=100, font=('Helvetica', 20, 'bold'),
            ...
            if os.path.exists(level_path):
                for f in os.listdir(level_path):
                    if f.lower().endswith(('.png', '.jpg', '.jpeg', '.gif')):
                        self.images_by_level[level].append(
...
class DashboardWindow:
    ...
    def display_home(self):
        ...
        label = tk.Label(self.main_frame,
                         ...
                         font=("Helvetica", 14), fg=FG_COLOUR, bg=BG_COLOUR)
    ...
    def open_quiz_window(self, quiz_data):
        ...
        if hasattr(self, 'selected_quiz_path'):
            ...
            match = re.search(r"level(\d)(grammar|spelling|vocabulary)", filename)
            if match:
    ...
    def show_selected_data(self):
        ...
        if os.path.exists(file_path):
            ...
            # Can't edit after inserting content
            self.text_widget.config(state=tk.DISABLED)
