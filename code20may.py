...
# Data for the quiz questions, options, and answers
data = {
    'question': [
...
# All the code for the question window
class QuestionWindow:
    ...
    def finish(self):
        ...
        self.signup_window.destroy()
        self.window.destroy()
        self.open_level_quiz_window()
        self.open_dashboard() # not working!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!

    # Code to open the quiz (the user chooses shuffled or normal order)
    def open_level_quiz_window(self):
        ...
        LevelQuiz(popup_q1, self.user_info) # not working!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
