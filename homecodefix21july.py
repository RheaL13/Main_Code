...
class QuizSelect:
    ...
    def __init__(self, parent, level_number):
    ...
    def display_variable(self, numberlevel):    
        # Title Label
        title = tk.Label(self.dialog, text="Select the Quiz Area",
                         font=("Helvetica", 16, "bold"), fg="black", bg="oldlace")
        title.pack(pady=30)

        numberlevel = self.level_number.levelnumber

        a_instance = LevelQuiz()
        b_instance = QuizSelect(a_instance)
        b_instance.display_variable()
        
        # Heading Label for level of quiz
        heading = tk.Label(self.dialog, text=f"These quizzes are for level {numberlevel}",
                         font=("Helvetica", 15, "bold"), fg="black", bg="oldlace")
        heading.pack(pady=20)

        level_heading = tk.Label(self.dialog, text = "If you would like to do another level please choose below:",
                            font = ("Helvetica", 15, "bold"), fg = "black", bg = "oldlace")
        level_heading.pack(pady = 20)

        # dropdown box for a different level quiz
        #....
