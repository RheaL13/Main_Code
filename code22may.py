...
class QuestionWindow:
    ...
    def open_level_quiz(self):                                                      #!!!!!!!!!!!!!! fix function not working
        """Open level quiz window when all completed."""
        levelquizwindow=tk.Toplevel()
        levelquizwindow.title("QUIZ")
        ...
        LevelQuiz(levelquizwindow, self.user_info)

        #self.level_quiz=LevelQuiz
        #LevelQuiz(self, root, self.user_info)
